        ...
        >
          ...
          >
            <span className="text-sm font-medium text-accent tracking-widest px-5 py-2.5 bg-accent/5 rounded-full border border-accent/15">
              🚀 AIML UNDERGRAD AT Sahyadri College of Engineering and Management
            </span>
          </motion.div>
          ...
          >
            ...
            <MagneticButton onClick={() => window.open('https://drive.google.com/file/d/1xIr15tRhqIBQA0zCo3dIrytwkE2zlATJ/view?usp=sharing', '_blank')}>
              Resume
